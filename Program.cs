...
class Program
{
    ...
    public static void Main()
    {
        ...
        List<Button> buttons = new List<Button>{
            ...
            new Button(new Vector2(640, 10),150,30,rectangleColor,true,0.3f,new TextLabel("Pomodoro",new Vector2(10,0),Color.White,15),new ImageExtened("pomo_icon.png",new Vector2(-45,0),Color.White,0.75f,0f)),

            new Button(new Vector2(10, 85),150,30,rectangleColor,true,0.3f,new TextLabel("New Task",new Vector2(-30,0),Color.White,10),new ImageExtened("plus_icon.png",new Vector2(35,2),Color.White,0.8f,0f)),
            new Button(new Vector2(170, 85),150,30,rectangleColor2,true,0.3f,new TextLabel("New Project",new Vector2(-30,0),rectangleColor,10),new ImageExtened("plus_icon.png",new Vector2(35,2),rectangleColor,0.8F,0f)),
            
            new Button(new Vector2(550, 85),30,30,rectangleColor,true,0.3f,new TextLabel("All",new Vector2(0,0),Color.White,10)),
            new Button(new Vector2(600, 85),50,30,rectangleColor3,true,0.3f,new TextLabel("Tasks",new Vector2(0,0),Color.White,10)),
            new Button(new Vector2(650, 85),70,30,rectangleColor3,true,0.3f,new TextLabel("Projects",new Vector2(0,0),Color.White,10)),
