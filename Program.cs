        ...
        while (!WindowShouldClose())
        {
            ...
            if (ImGui.Begin("Something", ImGuiWindowFlags.NoTitleBar | ImGuiWindowFlags.NoCollapse | ImGuiWindowFlags.NoResize | ImGuiWindowFlags.NoMove | ImGuiWindowFlags.NoBackground))
            {
                ...
                //Column 1
                {
                    ...
                    DrawCard("History Card", screenWidthIn3 - 75, 18f, convertToVector4(otherColor), false, () =>
                   {
                       ImGui.SameLine(10);
                    ...
                    for (int i = 0; i < 30; i++)
                    {
                        DrawCard("Completed Card: " + i, screenWidthIn3, 120, convertToVector4(cardColor), false, () =>
                        {
                            ImGui.SetCursorPosX(ImGui.GetCursorPosX() + 10f);
                ...
                //Column 2
                {
                    ...
                    DrawCard("Input Card", screenWidthIn3, 130, convertToVector4(cardColor), false, () =>
                    {
                        ImGui.SetCursorPosX(ImGui.GetCursorPosX() + 10f);
                        ImGui.SetCursorPosY(ImGui.GetCursorPosY() + 10f);
                        ...
                        ImGui.SetCursorPosX(ImGui.GetCursorPosX() + 10f);
                        DrawCard("Project name 2", screenWidthIn3 * 0.35f, 18f, convertToVector4(blueColor), false, () =>
                                                                     {
                ...
                //New Project Modal
                {
                    ...
                    if (ImGui.BeginPopupModal("New Project", ref o, popup_flags))
                    {
                        ...
                        {
                            tasks.Add(RandomNumberGenerator.GetInt32(10000));
                            // ImGui.CloseCurrentPopup();
                        }
